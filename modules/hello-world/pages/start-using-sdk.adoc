...
Go to our xref:platform-help.adoc[Platform Introduction] if you don't already have an editor setup for working in Go -- e.g. you are evaluating the Go SDK, but Go is not your normal platform.
